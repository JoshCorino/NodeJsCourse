...
const testArray = [{name: "Mary", money: 1000}, {name: "Jon", money: 54}, {name: "Richard", money: 0}];
console.log("testArray with haveMoney filter:",customFilterUnique(testArray,haveMoney));
/*
